# GSX2JSONPP - Google Spreadsheet to JSON API service C/C++.

Inspired by [gsx2Json](https://github.com/55sketch/gsx2json). 
...
Copy your own `cert.pem, key.pem` file under bin folder. 
Certifications will be automatic generates when not provide.
...
[Example spread sheet](https://docs.google.com/spreadsheets/d/1-DGS8kSiBrPOxvyM1ISCxtdqWt-I7u1Vmcp-XksQ1M4/edit#gid=0)
